...
| #   | Dòng                                                                                            | Nội dung                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| --- | ----------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | Track + đề                                                                                      | A · VLearn (track 1) — tính năng mới: **Ghi chú thông minh** — AI so ghi chú của học viên với transcript + slide để sinh câu hỏi ôn tập và chỉ ra kiến thức bị ghi sót.                                                                                                                                                                                                                                                                                           |
| 2   | Job executor (ai · đang ở đâu · làm gì)                                                         | Học viên đang xem bài giảng trên VLearn, vừa ghi chú xong những ý mình cho là quan trọng.                                                                                                                                                                                                                                                                                                                                                                         |
| 3   | Pain một câu (ai – đang làm gì – vướng đâu – hậu quả)                                           | Học viên ghi chú xong không biết mình có ghi sót ý quan trọng nào không, và không có câu hỏi ôn tập từ chính ghi chú → đến lúc ôn không biết mình thiếu phần nào.                                                                                                                                                                                                                                                                                                 |
| 4   | 1–2 bằng chứng đầu (số + cách đếm + mã hội thoại/tin nhắn, hoặc khảo sát/phỏng vấn có số người) | ① VLearn hiện **không có tính năng ghi chú cá nhân** trong trang học — học viên ghi ngoài (giấy/Notion/tự nhớ), không có gì để so với nội dung bài. ② Data có sẵn "nguồn sự thật" để so: `6 transcript` có mã đoạn `[Txx-NNN]` + `2 bộ slide` (d1, d2). ③ Khảo sát nhanh `XX` học viên: `XX/XX` ghi chú nhưng không biết mình ghi sót ý nào; `XX/XX` muốn có câu hỏi ôn tập từ chính ghi chú.                                                                     |
| 5   | Lát cắt MỘT CÂU (1 user · 1 việc · 1 quyết định AI · 1 kết quả)                                 | Một học viên · vừa ghi chú xong một buổi học trên VLearn · AI so ghi chú với transcript + slide để quyết định ý quan trọng nào chưa được ghi và sinh câu hỏi ôn tập từ chính ghi chú · học viên biết mình thiếu kiến thức gì và có câu hỏi để tự kiểm.                                                                                                                                                                                                            |
| 6   | AI tự làm đến đâu + 1 dòng lý do · ≥3 willing users ngoài nhóm                                  | **Tự làm:** nhận ghi chú + transcript + slide → đối chiếu → sinh câu hỏi ôn tập + danh sách "ý có trong bài nhưng chưa thấy trong ghi chú" kèm nguồn `[Txx-NNN]`. **Không tự làm:** kết luận "bạn hiểu sai/không hiểu" (ghi chú là tóm tắt chủ quan); không tự sửa ghi chú của học viên. **Lý do:** kết luận sai về mức hiểu làm học viên ôn lệch trọng tâm, mất niềm tin → mức **Conditional**. **Willing users (ngoài nhóm, đã hỏi và đồng ý):** Phạm Thanh Sơn (2A202602794), Trần Hoàng Duy Anh (2A202602558). |
| 7   | Phân công có tên                                                                                | **Phan Duy Thành (2A202602930)** — Đội trưởng · product lead: canvas/spec, system prompt, output contract · **Phạm Thị Ngọc Anh (2A202602831)** — evidence & data: khảo sát học viên, mining transcript/slide, golden set · **Võ Đức Tài (2A202603007)** — prototype: build luồng ghi chú + lời gọi AI thật (đối chiếu ghi chú ↔ transcript/slide) · **Đỗ Đình Long (2A202602673)** — UI & validate: giao diện, 4 đường trải nghiệm, user test + changelog.       |
